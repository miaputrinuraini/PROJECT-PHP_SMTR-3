        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              <div class="icon"><i class="download.img"></i></div>
              <h4 class="title"><a href="">Alamat</a></h4>
              <p class="description">Jl.Poros Desa Lubuk Sakai, Kec.Kampar Kiri Tengah,Kab.Kampar, Provinsi Riau</p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight">
              ...
              <p class="description">Mdta At.taufiq Lubuk Sakai</p>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              ...
              <h4 class="title"><a href="">No.Tlp/ WA </a></h4>
              <p class="description">+6281338250696 (Komaruddin)</p>
            </div>
          </div>
